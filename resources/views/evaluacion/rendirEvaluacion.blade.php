	...
	<div id="eva-rightSection">
		...
		<section class="eva-controles" >
			<h3 style="text-align: center;">
				...
				<a class="btn btn-primary btn-md"  role="button" id="eva-btnEnviarTodo" data-test='{{ $test["id"] }}'>Enviar Todo y Terminar</a>
