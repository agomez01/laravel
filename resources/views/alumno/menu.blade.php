<li><a  class="cuaderno" href="{{ Salir::link('alumno/mis_clases.php') }}"  target='blank'>Mis Cuadernos</a></li>
<li><a class="misnotas" href="{{ Salir::link('libro_clases_alumno/notas_alumno.php') }}" target='blank'>Mis Notas</a></li>
